...
static const int vertpadbar         = 17;
...
static const char *fonts[]          = {"Iosevka:style:medium:size=12", "Jetbrains Nerd Font Mono:style:medium:size=19", "Hack Nerd Font Mono:style:medium:size=19" };

// theme
#include "themes/radium.h"

static const char *colors[][3]      = {
    /*                     fg       bg      border */
    [SchemeNorm]       = { gray3,   black,  black },
    [SchemeSel]        = { gray4,   blue,   gray2 },
    [SchemeTitle]      = { white,   black,  gray2 }, // active window title
    [TabSel]           = { blue,    gray2,  gray2 },
    [TabNorm]          = { gray3,   black,  gray2 },
    ...
    [SchemeLayout]     = { green,   black,  gray2 },
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,                 XK_p,           spawn,          SHCMD("SUDO_ASKPASS=$HOME/.local/bin/askpass-rofi rofi -show drun -run-command 'sudo -A {cmd}'")},
